...
# -*- coding: utf-8 -*-
#
# personal-website documentation build configuration file, created by
...
modindex_common_prefix = ["personal-website"]
...
basename = "personal-website".replace(" ", "").replace(".", "")
